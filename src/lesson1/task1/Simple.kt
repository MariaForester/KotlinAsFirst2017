 ...
 */
fun lengthInMeters(sagenes: Int, arshins: Int, vershoks: Int): Double = (sagenes * 48 + arshins * 12 + vershoks) * 0.04445
 ...
 */
fun angleInRadian(grad: Int, min: Int, sec: Int) = (grad + min / 60.0 + sec / 3600.0) * PI / 180
 ...
 */
fun accountInThreeYears(initial: Int, percent: Int): Double = initial * pow(1 + percent * 0.01, 3.0)
